...
class Purchase(object):
    ...
    IMPROVEMENT_COST = DATA["PURCHASE"]["IMPROVEMENT_COST"] # CapEx, repair, new appliances, etc.
    CLOSING_COST = DATA["PURCHASE"]["CLOSING_COST"] # mortgage cost, title transfer, etc.
    PRE_RENT_HOLDING_COST = 0 # TODO, e.g. 1 month of mortgage, tax, insurance, utility?

    _TOTAL_COST = PURCHASE_PRICE + IMPROVEMENT_COST + CLOSING_COST + PRE_RENT_HOLDING_COST
